...
-   Skills corner: The craft of research (25 minutes)
...
-   [Miro](https://miro.com/welcomeonboard/M1YrT2hMZUJpQzVXV1FsSExaQWRtaG9FSjZIc0VlVG0ySmcrSHo2WEJDZGx3aWx2MjNXQmtvY3h3cjNaK1lXQ2F3MGlGTitZL2tMMk5TRXpSeVlEKzBTMDI4STYzVjJHVTkwWFlDRkF2YUcxci9ldnYvY1h6bDVOUDNDMUt1d2UhZQ==?share_link_id=81401689235)
...
-   *Part III:* Activity period
    ...
    -   (Weeks 8 -- 14) Replication: One group tasked with using data from one of my current or published papers to replicate analyses and comment on that process and raise questions for general awareness
...
- This may run counter to your goals and preferences to make a practical contribution

  - example: explain versus optimize


## A pictoral representation of the research process (we will revisit this in class 7)
