...
![](assets/alittleaboutme2.jpeg){style="transform: rotate(0deg);"}  
...
-   [Dropbox](https://www.dropbox.com/scl/fo/ny0hiyu93bep31udth6ot/h?rlkey=or2mfwzqbdzkwbv8ky4yws5h7&dl=0) (download a local copy for yourself, feel free to add selective highlights for group discussions)

-   [PollEverywhere](https://PollEv.com/drfox)

-   [Whiteboard](https://whiteboard.cloud.microsoft/me/whiteboards/p/c3BvOmh0dHBzOi8vYmVudGxleWVkdS1teS5zaGFyZXBvaW50LmNvbS9wZXJzb25hbC9iZm94X2JlbnRsZXlfZWR1/b!HwsUH5Oyzk-Y0yDYQ73hUWeGxFZZG8VOj2t6usLJY4_dF8vzU6PfTpclBVXpMpPy/01DPHGHQKO5GPKYHXTZJFZWMWQSG4RKH2P)

-   [Current Events](https://briancfox.com/ResearchDesign/docs/currentevents.html)
...
- These contributions are often directional, with respect to a target audience
  ...
  - Example: Nash equilbria (von Neumann versus economists)
  
<!--- https://en.wikipedia.org/wiki/Nash_equilibrium Whereas economists saw nash equilibria as a significant step forward in non-cooperative game theory, von Neumann observed that it was just a trivial case of a fixed point theorem; but the insight lay in the application of that fixed point theorem to open questions in economists.  While the extension to fixed point theory may be minor, the extension to economics theory was substantial (See Nasar 1998 - Book a beautiful mind - for the quote --->
...
As a case study, Let's consider the last paper assigned for today: Delios et al. 2025

## Delios et al. (2025)

> Analysts used a wide variety of specifications to conduct their analyses. No two analysts adopted the same approach when we consider the variables, method, and sample selec- tion simultaneously. Material 4 on OSF provides a detailed summary table describing the specifications employed by each analyst for each research question. Supplement 2 sum- marizes the control variables used by the analysts.
