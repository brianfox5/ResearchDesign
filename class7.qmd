...
-   Core paper discussion (25 minutes)

-   Final Compare-contrast presentation (30 minutes)

-   *Break*

-   Skills corner: Descriptive statistics (30 minutes)

-   First pass at Class 8 materials (30 minutes)

# Grounding

## Switching things up a bit

- This class marks our transition from a research design to research methods focus

- Thus, the order of presentation is a little fluid this class, with less emphasis on discussing the core papers at length

## The rubber meets the road

-   Measures: Translating our variables into concrete measures (these do not need to be 1 to 1)

-   (Sourcing) Data: Where are we going to find these measures? [to be discussed in workshop]
...
::::: columns
::: {.column width="60%"}
> Paraphrasing N. R. Campbell (Final Report, p. 340),. we may say that measurement, in the broadest sense, is defined as the assignment of numerals to objects or events according to rules. The fact that numerals can be assigned under different rules leads to different kinds of scales and different kinds of measurement. [@stevens1946, 677]
:::

::: {.column width="40%"}
[![](assets/Stevens%201946.png)](https://www.dropbox.com/scl/fi/3lfx85tfizkb6henemnfq/Stevens-1946-198797.pdf?rlkey=8ofyudwtbv4fj5txuvewq06jp&dl=0)
:::
:::::

## Stevens (1946)

Discussion Questions (briefly)
...
![](assets/Stevens%201946%20scales.png)

## Heggestad et al (2019)

:::: columns
::: {.column height="100%"}
[![](assets/Heggestad%20et%20al%202019.png)](https://www.dropbox.com/scl/fi/nqxuttbuymt4hjzxwa7dn/Heggestad-et-al.-2019-260864.pdf?rlkey=fhpcma39vk6rje8n4dua5cdb1&dl=0)
:::
::::
...
-   While this is a nice list of 'sanity checks', is this really all that descriptive statistics can tell us? [more to come in a bit on this point]
...
Inferential statistics provide you the means to generalize that story beyond your sample given certain assumptions (often, but not always, by appealing to a parametric model)
...
::::: columns
::: {.column width="50%"}
![Anscombes' Quartet](assets/anscombes%20quartet.png)
:::

::: {.column width="50%"}
![The Datasaurus Dozen](assets/datasaurus%20dozen.png)
:::
:::::
...
## From descriptives to inference

- As we just covered, descriptive statistics can be very powerful, but often we want to move from the sample to the population.  

- In other words, we seek to make broader *inferences*

- There are many ways to do this, but a common workhorse is *regression*, which will serve as the backbond of the next several weeks

## Recall: The paradigm of our class
...
- Note that you may need to include elements outside of your model of interest to specify the causal system (Class 5: Models + Hypotheses)

- Also note that our model may be influenced by observable and unobservable factors (Class 6: Constructs + Variables)
...
## Let's take a quick preview of Class 8 now
...
We have two objectives with our workshop today:

1. Share your updated research questions and models 

2. Expose you to two tools that *may* help perform your empirical work 
    - WRDS: a goldmine of organizational level data
    - RStudio: a powerful envirionment to perform statistical analyses

Given the way the time breaks down, we will do 2. and then 1. 

## Workshop Agenda

-   Pulse Check

-   Sourcing data (11-12p)

    - Generally
    - Worked example with WRDS and R

-   Research Model Presentations (1-4p)
...
- Given the variation in your interests and topics, it is not productive to talk at length about data sourcing since it is unique to your circumstances (but we will walk through one example)
...
-   Experiments (lab or field) with purpose-built collection instruments
...
Relying upon others to collect data or using 'unobtrusive' measures
...
## Example: Sourcing and analyzing data using WRDS and R

- WRDS
  - A commonly employed data source for business search, containing hundreds of databases
  - Not all are accessable, the licenses are institution dependent
  - Many mentioned above accessed here (e.g., CRSP, Compustat, BoardEx)
  
- R Studio
  - A powerful statistical software environment that allows you to analyze, visualize, and report empirical data and results

## Protocol

1. Set-up RStudio and test it is working
2. Set-up WRDS
3. Get some data from WRDS
4. Run some basic commands in RStudio

## RStudio Setup

- Install R: https://cran.rstudio.com/
- Install R Studio: https://posit.co/download/rstudio-desktop/
- Load up R Studio and walk through the environment using "Elementary R References" in Dropbox
    - Principles of Econometrics in R (pp. 9-12)
    - R for Data Science (Ch. 1)
- Quick tour of the "mpg" dataset using ggplot (for generating graphics)

## Getting new data: WRDS 

- I will provide you instructions for how to set up your account with a class code in the Class 7 Workshop folder on Dropbox
- Use the link on the website to get to WRDS: https://wrds-www.wharton.upenn.edu/pages/
- Login using the details provided
- [Let's switch to a quick exercise to download some stock price data](https://wrds-www.wharton.upenn.edu/documents/1602/introduction-to-wrds-getting-started-slide-deck.pptx)

## Examining the data with RStudio

1. Save your CRSP data to the desktop with name "crspdata.txt"
2. Go to R Studio
3. Open the "Class 7 Example" file I have provided in Dropbox
4. Let's work from there

## Questions before switching gears?
