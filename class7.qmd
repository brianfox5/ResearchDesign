...
-   Sourcing data: A starting point (20 minutes)
...
-   Sourcing data using WRDS (11 - 12p)

-   First Pass at Class 8 Materials (1 - 1:30p)

-   Research Question Presentations (1:30 - 3:30p)
...
- You received an email from me to get signed up for WRDS

## A worked example with WRDS

- Identifying the question

- Getting the data

- Exploring in R Studio

## Getting the data with WRDS
