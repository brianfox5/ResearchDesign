...
-   Key thinking tool: DAGs x formal theory (15 minutes)
...
## Van Maanen Sorensen and Mitchell (2007)

::::{.columns}

:::{.column height="100%"}

[![](assets/Van Maanen 2007.png)](https://www.dropbox.com/scl/fi/lq2pxgx5hl7gomoxnbyev/Van-Maanen-S-rensen-and-Mitchell-2007-84045.pdf?rlkey=4u0iuvwm9z12jnwfejmqe7lql&dl=0)
...
- How does the interplay of theory and method play out when thinking about constructs and hypotheses?

- How might constructs enable or constrain variable identification and vice versa?


## Van Maanen Sorensen and Mitchell (2007)

Key Points [@maanen2007,1147]

Theory can drive method via:

  - its stage of articulation 
  
  - the types of **constructs** it proposes
  
  - its descriptive or pre scriptive nature. 
  
Method can drive theory: 

- analysis of configurations

- simulation modeling

- analysis of surprising or unexpected data (**variables**)
